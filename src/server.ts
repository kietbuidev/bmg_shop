...
const allowedOrigins = ['http://localhost:3000', 'http://localhost:3001' , 'https://bmgshop-production.up.railway.app', 'http://192.168.0.115:3000', 'http://192.168.0.118:3001', 'http://192.168.0.118:3000' , 'https://bmg-admin-shop.vercel.app', '*', 'https://qrb4lrbv-3000.asse.devtunnels.ms'];
