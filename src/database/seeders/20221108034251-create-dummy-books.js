  ...
  async up (queryInterface, Sequelize) {
    ...
    return queryInterface.bulkInsert('Book', [
      ...
      },
      {
        ...
        title: "She's Gone",
        publisher: "Vulcan",
        description: "words, consectetur, from a Lorem Ipsum passage, and going through the cites of the word in classical literature",
        genre: "Drama",
        numberOfPages: 205,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        publisher: "BOOKS",
        description: "to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition",
        genre: "Psephology",
        numberOfPages: 150,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        title: "The Choice",
        publisher: "BeoBook",
        description: "more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going through the cites of the word in classical literature, discovered",
        genre: "Adventure",
        numberOfPages: 380,
        createdAt: new Date(),
        updatedAt: new Date(),
